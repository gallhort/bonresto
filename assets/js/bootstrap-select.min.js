    ...
    !(function (F) {
            ...
            (u.prototype = {
                ...
                createDropdown: function () {
                    var e,
                        ...
                        l = "";
                    return (
                        this.options.header && (s = '<div class="' + q.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
                        ...
                        this.multiple &&
                            ...
                            (l = '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm ' + q.BUTTONCLASS + '">' + this.options.doneButtonText + "</button></div></div>"),
                        (e =
                ...
                createView: function (C, e) {
                    ...
                    this.setPositionData(),
                        ...
                        F(window)
                            ...
                            .on("resize" + L + "." + this.selectId + ".createView", function () {
                ...
                createLi: function () {
                    ...
                    var e,
                        W = { span: document.createElement("span"), subtext: document.createElement("small"), a: document.createElement("a"), li: document.createElement("li"), whitespace: document.createTextNode("\xa0") },
                        ...
                        if ((R++, !t.hasClass("bs-title-option"))) {
                            ...
                            if (!0 === n.hidden || (T.options.hideDisabled && ((v && !f) || m))) {
                                (i = n.prevHiddenIndex),
                                    ...
                                    g && "divider" !== L[L.length - 1].type && (R++, D.push(M(!1, q.DIVIDER, N + "div")), L.push({ type: "divider", optID: N }));
                            } else {
                                if (f && !0 !== n.divider) {
                                    ...
                                    (s = V({ text: a, optionContent: r, optionSubtext: d, optionIcon: h })),
                                        D.push(M(U(s, "opt " + o + I, l), "", N)),
                                        L.push({ content: r || a, subtext: d, tokens: c, type: "option", optID: N, headerIndex: P, lastIndex: P + u.childElementCount, originalIndex: e, data: n }),
                                        H++;
                                    ...
                                    g && "divider" !== L[L.length - 1].type && (R++, D.push(M(!1, q.DIVIDER, N + "div")), L.push({ type: "divider", optID: N })),
                                        (s = V({ text: a, optionContent: r, optionSubtext: d, optionIcon: h })),
                                        D.push(M(U(s, o, l))),
                                        L.push({ content: r || a, subtext: d, tokens: c, type: "option", originalIndex: e, data: n }),
                                        H++;
                                }
                    ...
                    if (e || (!1 !== this.options.size && !this.sizeInfo)) {
                        ...
                        var v,
                            ...
                            C = {
                                ...
                                horiz:
                                    z(S ? S.paddingLeft : y.css("paddingLeft")) + z(S ? S.paddingRight : y.css("paddingRight")) + z(S ? S.borderLeftWidth : y.css("borderLeftWidth")) + z(S ? S.borderRightWidth : y.css("borderRightWidth")),
                            },
                            O = {
                        ...
                        this.setMenuSize(),
                            "auto" === this.options.size
                                ? (this.$searchbox.off("input.setMenuSize propertychange.setMenuSize").on("input.setMenuSize propertychange.setMenuSize", function () {
                                  ...
                                  s
                                      .off("resize" + L + "." + this.selectId + ".setMenuSize scroll" + L + "." + this.selectId + ".setMenuSize")
                                      .on("resize" + L + "." + this.selectId + ".setMenuSize scroll" + L + "." + this.selectId + ".setMenuSize", function () {
                                          return i.setMenuSize();
                                      }))
                                : this.options.size &&
                                  "auto" != this.options.size &&
                                  this.selectpicker.current.elements.length > this.options.size &&
                                  (this.$searchbox.off("input.setMenuSize propertychange.setMenuSize"), s.off("resize" + L + "." + this.selectId + ".setMenuSize scroll" + L + "." + this.selectId + ".setMenuSize")),
                            e
                ...
                selectPosition: function () {
                    ...
                    this.$button.on("click.bs.dropdown.data-api", function () {
                        ...
                        F(window)
                            .off("resize" + L + "." + this.selectId + " scroll" + L + "." + this.selectId)
                            .on("resize" + L + "." + this.selectId + " scroll" + L + "." + this.selectId, function () {
                    ...
                    i || (i = this.selectpicker.main.map.newIndex[e]),
                        ...
                        a ||
                            (!r &&
                                ...
                                ((n = this.selectpicker.main.map.newIndex[this.prevActiveIndex]), (o = this.selectpicker.main.elements[n]).classList.remove("active"), o.firstChild && o.firstChild.classList.remove("active")));
                },
                        ...
                        this.$searchbox.on("input propertychange", function () {
                            ...
                            if (((u.selectpicker.search.map.newIndex = {}), (u.selectpicker.search.map.originalIndex = {}), (u.selectpicker.search.elements = []), (u.selectpicker.search.data = []), e)) {
                                ...
                                for (var c = n.length; r < c; r++) {
                                    ...
                                    ("divider" !== a.type || ("divider" === a.type && p && "divider" !== p.type && c - 1 !== r)) &&
                ...
                keydown: function (e) {
                    ...
                    if (
                        (!(i = a.$newElement.hasClass(q.SHOW)) && (p || (48 <= e.which && e.which <= 57) || (96 <= e.which && e.which <= 105) || (65 <= e.which && e.which <= 90)) && a.$button.trigger("click.bs.dropdown.data-api"),
                        ...
                        e.which === H
                            ...
                            : (e.which === A || h) && (0 === t ? (v = a.$menuInner[0].scrollTop = 0) : (d = u < (o = (n = a.selectpicker.current.data[v]).position - a.sizeInfo.menuInnerHeight))),
                    ...
                    i &&
                        ((e.which === T && !a.selectpicker.keydown.keyHistory) || e.which === O || (e.which === D && a.options.selectOnTab)) &&
                        (e.which !== T && e.preventDefault(),
                        (a.options.liveSearch && e.which === T) || (a.$menuInner.find(".active a").trigger("click", !0), l.focus(), a.options.liveSearch || (e.preventDefault(), F(document).data("spaceSelect", !0))));
                },
                mobile: function () {
        ...
        (F.fn.selectpicker = v),
            ...
            F(document)
                ...
                .on("keydown" + L, '.bootstrap-select [data-toggle="dropdown"], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', u.prototype.keydown)
